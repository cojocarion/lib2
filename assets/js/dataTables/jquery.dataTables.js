    ...
    (function (factory) {
        ...
        /** @lends <global> */ function ($) {
            ...
            var _isNumber = function (d, formatted) {
                ...
                return (
                    !d || d === '-' || (!isNaN(parseFloat(d)) && isFinite(d))
                );
            };
            ...
            function _fnGetRowData(oSettings, iRow, sSpecific, aiColumns) {
                ...
                for (var i = 0, iLen = aiColumns.length; i < iLen; i++) {
                    out.push(
                        _fnGetCellData(oSettings, iRow, aiColumns[i], sSpecific)
                    );
                }
                return out;
            }
            ...
            function _fnGetObjectDataFn(mSource) {
                if ($.isPlainObject(mSource)) {
                    ...
                    return function (data, type, extra) {
                        return o[o[type] !== undefined ? type : '_'](
                            data,
                            type,
                            extra
                        );
            ...
            function _fnScrollDraw(settings) {
                ...
                if (footer) {
                    settings.nScrollFoot.style.width = _fnStringToCss(
                        correction
                    );
                }
                ...
                this.each(function () {
                    ...
                    if (rowOne.length) {
                        var a = function (cell, name) {
                            return cell.getAttribute('data-' + name)
                                ? name
                                : null;
                        };
                ...
                if (_pluck(settings.aoData, '_details').length > 0) {
                    ...
                    table.on(
                        ...
                        function (e, settings, idx, vis) {
                            ...
                            for (
                                var i = 0, ien = settings.aoData.length;
                                i < ien;
                                i++
                            ) {
                                row = settings.aoData[i];
