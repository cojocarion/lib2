...
<div class="form-group">
<label>Statutul profilului : </label>
...
<div class="form-group">
<label>Introduceti numele complet</label>
...
<button type="submit" name="update" class="btn btn-primary" id="submit">Actualizează </button>
