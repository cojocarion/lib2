...
<head>
    ...
    <title>Online Library Management System | Detalii carte emisă</title>
...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Detalii carte emisă</h4>
...
<div class="form-group">
<label>Data emitere carte :</label>
<?php echo htmlentities($result->IssuesDate);?>
</div>


<div class="form-group">
<label>Data returnare carte :</label>
<?php if($result->ReturnDate=="")
                                            {
                                                echo htmlentities("Nu a fost returnată");
                                            } else {
