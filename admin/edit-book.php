...
<head>
    ...
    <title>Online Library Management System | Editare carte</title>
...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Adaugă carte</h4>
...
<label>Nume carte<span style="color:red;">*</span></label>
...
<div class="form-group">
<label>ISBN Numpr<span style="color:red;">*</span></label>
<input class="form-control" type="text" name="isbn" value="<?php echo htmlentities($result->ISBNNumber);?>"  required="required" />
<p class="help-block">ISBN este numărul internațional al cărții.ISBN trebuie să fie unic</p>
</div>

 <div class="form-group">
 <label>Preț în USD<span style="color:red;">*</span></label>
 <input class="form-control" type="text" name="price" value="<?php echo htmlentities($result->BookPrice);?>"   required="required" />
 </div>
 <?php }} ?>
<button type="submit" name="update" class="btn btn-info">Actualizează </button>
